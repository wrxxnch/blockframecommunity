...
import { fetchPosts, subscribeToPosts, syncLocalPostsToFirestore } from "./lib/api";
...
export default function App() {
  ...
  useEffect(() => {
    // Sync any previous local creations to Firestore so they are globally public
    syncLocalPostsToFirestore().catch((err) => console.warn("Local sync notice:", err));

    refreshPosts();

    // Attach realtime listener so everyone sees posts created by anyone live
